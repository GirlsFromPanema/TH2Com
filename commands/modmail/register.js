...
module.exports = {
	name: 'register',
	description: 'Opens a registration thread',
	usage: '<userID>',
	...
	async execute({ client, message }) {
		...
		try {
			await user.send({
				embed: {
					description: '**Registration**\nPlease enter your registration form** [Example](https://discord.com/channels/827257197565837312/854714620660809738/854715477904850964)**',
					color: 0x5DE67B
				}
			});
		} catch {
