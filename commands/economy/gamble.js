...
module.exports = {
	...
	async execute({ message, args, settings, client, prefix }) {
		...
		if (amount > 50000) return msg.edit('You cant bet more than 50000!', { embed: null });
		...
		if (win) {
			return msg.edit(`You won <:th2:827279307574738964> **${amount}** Coins!`, { embed: null });
		}
		return msg.edit(`:x: | You lost <:th2:827279307574738964> **${amount}** Coins!`, { embed: null });
	}
};
